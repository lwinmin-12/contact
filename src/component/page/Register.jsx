...
import { InputTag } from '../smallComponent'

const Register = () => {
  return (
    <div className="flex justify-center items-center h-[90.5vh] overflow-hidden">
      <div className="w-[50%]">
        <img
          className="w-full object-contain"
          src="https://alyssiun.com/assets/images/feature/experience.png"
          alt=""
        />
      </div>
      <div className=" p-5 w-[50%]">
        <div className="text-center  flex flex-col items-center space-y-3 border rounded-lg shadow-[3px_4px_14px_1px] shadow-slate-200 w-[80%] mx-auto p-6">
          ...
          <h3 className="text-2xl font-light">Register Now</h3>
          <p className="text-gray-500 font-light">Create your Google Account</p>
          <form className=" w-[60%] space-y-5" action="">
            <InputTag id={"email"}>Email or Phone Number</InputTag>
            <InputTag id={"userName"}>User Name</InputTag>  
            <InputTag id={'password'}>password</InputTag>
            <div className="flex justify-end items-center">
              <a className="text-blue-600 hover:text-blue-800 text-md">Create Account</a>
